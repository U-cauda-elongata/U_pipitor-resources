...
let rule = [
  ...
  Rule::{
    ...
    topics = [
      ...
      -- ミレニアムプロ公式チャンネル
      Feed "https://www.youtube.com/xml/feeds/videos.xml?channel_id=UCqr_vXSGp5ONG94GY7SAxeA",
      -- Appirits Games Project
      Feed "https://www.youtube.com/xml/feeds/videos.xml?channel_id=UCojpaahbZqMmvt-7X1am1lg",
      -- KADOKAWAanime
